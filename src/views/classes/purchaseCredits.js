...
import { List, ListItem, Paper, Box, ListItemIcon, ListItemText, Card, CardContent, Grid  } from '@material-ui/core';
    ...
    <>
      {/* Class Filters Dialog Modal */}
        ...
        <DialogContent dividers>
          <Box px={2} pb={2}>
            <Typography variant="h2" gutterBottom>Buy a package</Typography>
          </Box>
          <Box px={2} pb={2}>
            <Typography variant="h4" gutterBottom>Memberships</Typography>
          </Box>
          <Box px={2}>
